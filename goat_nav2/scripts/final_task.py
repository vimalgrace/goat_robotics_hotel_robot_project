...
class HotelNavigator(BasicNavigator):

    def __init__(self):
        super().__init__("goat_navigator")
        ...
        self.root = tk.Tk()
        self.root.wm_title("Hotel Management")
        ...
        self.table_1_pose = [6.38, -4.6, 0.0]
        self.table_2_pose = [3.0, -1.7, -3.14]
        self.table_3_pose = [3.0, -8.2, -3.14]

        self.kitchen_pose = [1.67, -4.9, 0.0]
    ...
    def set_initial_pose(self):
        ...
        initial_pose.pose.position.x = 3.64
        initial_pose.pose.position.y = -4.94
